  ...
  return (
    <section className="auth-shell auth-shell-hh">
      <div className="card auth-card auth-card-hh">
        ...
        <p className="eyebrow">Личный кабинет JobFinder</p>
        <h1>{mode === "register" ? "Создать аккаунт" : "Вход в профиль"}</h1>
        <p className="muted">После входа вернем на: {backUrl}</p>
        <p className="muted">
          Для работодателей и администраторов используйте выбор роли в форме ниже.
        </p>
